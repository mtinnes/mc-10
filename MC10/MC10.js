...
MC10.prototype = {
    ...
    frame: function () {
        var cpu = this.cpu;
        var breakon = 14915; // NTSC 60hz
        var cycles = 0;
        while (cycles < breakon) {
            var cnt = cpu.emulate();
            cycles += cnt;
            //if (cycles % 10000 == 0) { // 1.12us per cycle
...
MC10.MC6803.prototype = {
    ...
    reset: function () {
        ...
        this.memory[0x0b] = 0xff; // overflow compare register defaults
    ...
    emulate: function () {
        ...
        if (opcode in this.optable) {
            ...
            for (var i = 0; i < cycles; i++) {
                ...
                if (this.cycleCount == (this.memory[0x0b] << 8) + this.memory[0x0c]) {
                    this.memory[0x08] |= 0x40; // set OCF (output compare flag)
                }
                if (this.cycleCount == 0xffff) {
                    this.memory[0x08] |= 0x20; // set TOF (timer overflow flag)
                }
            }

            //            var cc = this.flagsToVariable();
            //            this.history.push({ OP: opcode, last_PC: lastpc, PC: this.REG_PC, D: this.REG_D[0], X: this.REG_IP, S: this.REG_SP, CC: cc });
            //            this.idx++;
    ...
    inittable: function () {
        ...
        this.optable[0x99] = function () { self.memmode = self.DIRECT; self.ADCA(); return 2; };
        this.optable[0xa9] = function () { self.memmode = self.INDEX; self.ADCA(); return 2; };
        this.optable[0xb9] = function () { self.memmode = self.EXTENDED; self.ADCA(); return 2; };

        //ADCB 
        this.optable[0xc9] = function () { self.memmode = self.IMMEDIATE; self.ADCB(); return 2; };
        this.optable[0xd9] = function () { self.memmode = self.DIRECT; self.ADCB(); return 2; };
        this.optable[0xe9] = function () { self.memmode = self.INDEX; self.ADCB(); return 2; };
        this.optable[0xf9] = function () { self.memmode = self.EXTENDED; self.ADCB(); return 2; };

        //ADDA 
        this.optable[0x8b] = function () { self.memmode = self.IMMEDIATE; self.ADDA(); return 2; };
        this.optable[0x9b] = function () { self.memmode = self.DIRECT; self.ADDA(); return 2; };
        this.optable[0xab] = function () { self.memmode = self.INDEX; self.ADDA(); return 2; };
        this.optable[0xbb] = function () { self.memmode = self.EXTENDED; self.ADDA(); return 2; };

        //ADDB 
        this.optable[0xcb] = function () { self.memmode = self.IMMEDIATE; self.ADDB(); return 2; };
        this.optable[0xdb] = function () { self.memmode = self.DIRECT; self.ADDB(); return 2; };
        this.optable[0xeb] = function () { self.memmode = self.INDEX; self.ADDB(); return 2; };
        this.optable[0xfb] = function () { self.memmode = self.EXTENDED; self.ADDB(); return 2; };

        //ADDD 
        this.optable[0xc3] = function () { self.memmode = self.IMMEDIATE; self.ADDD(); return 4; };
        this.optable[0xd3] = function () { self.memmode = self.DIRECT; self.ADDD(); return 4; };
        this.optable[0xe3] = function () { self.memmode = self.INDEX; self.ADDD(); return 4; };
        this.optable[0xf3] = function () { self.memmode = self.EXTENDED; self.ADDD(); return 4; };

        //ANDA 
        this.optable[0x84] = function () { self.memmode = self.IMMEDIATE; self.ANDA(); return 2; };
        this.optable[0x94] = function () { self.memmode = self.DIRECT; self.ANDA(); return 2; };
        this.optable[0xa4] = function () { self.memmode = self.INDEX; self.ANDA(); return 2; };
        this.optable[0xb4] = function () { self.memmode = self.EXTENDED; self.ANDA(); return 2; };

        //ANDB 
        this.optable[0xc4] = function () { self.memmode = self.IMMEDIATE; self.ANDB(); return 2; };
        this.optable[0xd4] = function () { self.memmode = self.DIRECT; self.ANDB(); return 2; };
        this.optable[0xe4] = function () { self.memmode = self.INDEX; self.ANDB(); return 2; };
        this.optable[0xf4] = function () { self.memmode = self.EXTENDED; self.ANDB(); return 2; };
        ...
        this.optable[0x95] = function () { self.memmode = self.DIRECT; self.BITA(); return 2; };
        this.optable[0xa5] = function () { self.memmode = self.INDEX; self.BITA(); return 2; };
        this.optable[0xb5] = function () { self.memmode = self.EXTENDED; self.BITA(); return 2; };

        //BITB	
        this.optable[0xc5] = function () { self.memmode = self.IMMEDIATE; self.BITB(); return 2; };
        this.optable[0xd5] = function () { self.memmode = self.DIRECT; self.BITB(); return 2; };
        this.optable[0xe5] = function () { self.memmode = self.INDEX; self.BITB(); return 2; };
        this.optable[0xf5] = function () { self.memmode = self.EXTENDED; self.BITB(); return 2; };
        ...
        this.optable[0x91] = function () { self.memmode = self.DIRECT; self.CMPA(); return 2; };
        this.optable[0xa1] = function () { self.memmode = self.INDEX; self.CMPA(); return 2; };
        this.optable[0xb1] = function () { self.memmode = self.EXTENDED; self.CMPA(); return 2; };

        //CMPB	
        this.optable[0xc1] = function () { self.memmode = self.IMMEDIATE; self.CMPB(); return 2; };
        this.optable[0xd1] = function () { self.memmode = self.DIRECT; self.CMPB(); return 2; };
        this.optable[0xe1] = function () { self.memmode = self.INDEX; self.CMPB(); return 2; };
        this.optable[0xf1] = function () { self.memmode = self.EXTENDED; self.CMPB(); return 2; };
        ...
        this.optable[0x9c] = function () { self.memmode = self.DIRECT; self.CPX(); return 4; };
        this.optable[0xac] = function () { self.memmode = self.INDEX; self.CPX(); return 4; };
        this.optable[0xbc] = function () { self.memmode = self.EXTENDED; self.CPX(); return 4; };
        ...
        this.optable[0x98] = function () { self.memmode = self.DIRECT; self.EORA(); return 2; };
        this.optable[0xa8] = function () { self.memmode = self.INDEX; self.EORA(); return 2; };
        this.optable[0xb8] = function () { self.memmode = self.EXTENDED; self.EORA(); return 2; };

        //EORB	
        this.optable[0xc8] = function () { self.memmode = self.IMMEDIATE; self.EORB(); return 2; };
        this.optable[0xd8] = function () { self.memmode = self.DIRECT; self.EORB(); return 2; };
        this.optable[0xe8] = function () { self.memmode = self.INDEX; self.EORB(); return 2; };
        this.optable[0xf8] = function () { self.memmode = self.EXTENDED; self.EORB(); return 2; };
        ...
        this.optable[0xad] = function () { self.memmode = self.INDEX; self.JSR(); return 5; };
        this.optable[0xbd] = function () { self.memmode = self.EXTENDED; self.JSR(); return 5; };

        //LDAA	
        this.optable[0x86] = function () { self.memmode = self.IMMEDIATE; self.LDAA(); return 2; };
        this.optable[0x96] = function () { self.memmode = self.DIRECT; self.LDAA(); return 2; };
        this.optable[0xa6] = function () { self.memmode = self.INDEX; self.LDAA(); return 2; };
        this.optable[0xb6] = function () { self.memmode = self.EXTENDED; self.LDAA(); return 2; };

        //LDAB	
        this.optable[0xc6] = function () { self.memmode = self.IMMEDIATE; self.LDAB(); return 2; };
        this.optable[0xd6] = function () { self.memmode = self.DIRECT; self.LDAB(); return 2; };
        this.optable[0xe6] = function () { self.memmode = self.INDEX; self.LDAB(); return 2; };
        this.optable[0xf6] = function () { self.memmode = self.EXTENDED; self.LDAB(); return 2; };

        //LDD	
        this.optable[0xcc] = function () { self.memmode = self.IMMEDIATE; self.LDD(); return 3; };
        this.optable[0xdc] = function () { self.memmode = self.DIRECT; self.LDD(); return 3; };
        this.optable[0xec] = function () { self.memmode = self.INDEX; self.LDD(); return 3; };
        this.optable[0xfc] = function () { self.memmode = self.EXTENDED; self.LDD(); return 3; };

        //LDS	
        this.optable[0x8e] = function () { self.memmode = self.IMMEDIATE; self.LDS(); return 3; };
        this.optable[0x9e] = function () { self.memmode = self.DIRECT; self.LDS(); return 3; };
        this.optable[0xae] = function () { self.memmode = self.INDEX; self.LDS(); return 3; };
        this.optable[0xbe] = function () { self.memmode = self.EXTENDED; self.LDS(); return 3; };

        //LDX	
        this.optable[0xce] = function () { self.memmode = self.IMMEDIATE; self.LDX(); return 3; };
        this.optable[0xde] = function () { self.memmode = self.DIRECT; self.LDX(); return 3; };
        this.optable[0xee] = function () { self.memmode = self.INDEX; self.LDX(); return 3; };
        this.optable[0xfe] = function () { self.memmode = self.EXTENDED; self.LDX(); return 3; };
        ...
        this.optable[0x9a] = function () { self.memmode = self.DIRECT; self.ORAA(); return 2; };
        this.optable[0xaa] = function () { self.memmode = self.INDEX; self.ORAA(); return 2; };
        this.optable[0xba] = function () { self.memmode = self.EXTENDED; self.ORAA(); return 2; };

        //ORAB	
        this.optable[0xca] = function () { self.memmode = self.IMMEDIATE; self.ORAB(); return 2; };
        this.optable[0xda] = function () { self.memmode = self.DIRECT; self.ORAB(); return 2; };
        this.optable[0xea] = function () { self.memmode = self.INDEX; self.ORAB(); return 2; };
        this.optable[0xfa] = function () { self.memmode = self.EXTENDED; self.ORAB(); return 2; };
        ...
        this.optable[0x92] = function () { self.memmode = self.DIRECT; self.SBCA(); return 2; };
        this.optable[0xa2] = function () { self.memmode = self.INDEX; self.SBCA(); return 2; };
        this.optable[0xb2] = function () { self.memmode = self.EXTENDED; self.SBCA(); return 2; };

        //SBCB
        this.optable[0xc2] = function () { self.memmode = self.IMMEDIATE; self.SBCB(); return 2; };
        this.optable[0xd2] = function () { self.memmode = self.DIRECT; self.SBCB(); return 2; };
        this.optable[0xe2] = function () { self.memmode = self.INDEX; self.SBCB(); return 2; };
        this.optable[0xf2] = function () { self.memmode = self.EXTENDED; self.SBCB(); return 2; };
        ...
        this.optable[0xa7] = function () { self.memmode = self.INDEX; self.STAA(); return 3; };
        this.optable[0xb7] = function () { self.memmode = self.EXTENDED; self.STAA(); return 3; };
        ...
        this.optable[0xe7] = function () { self.memmode = self.INDEX; self.STAB(); return 3; };
        this.optable[0xf7] = function () { self.memmode = self.EXTENDED; self.STAB(); return 3; };

        //STD	
        //this.optable[0xcd] = function () { self.memmode = self.IMMEDIATE; self.STD(); return 5; };
        this.optable[0xdd] = function () { self.memmode = self.DIRECT; self.STD(); return 5; };
        ...
        this.optable[0xaf] = function () { self.memmode = self.INDEX; self.STS(); return 4; };
        this.optable[0xbf] = function () { self.memmode = self.EXTENDED; self.STS(); return 4; };
        ...
        this.optable[0xef] = function () { self.memmode = self.INDEX; self.STX(); return 4; };
        this.optable[0xff] = function () { self.memmode = self.EXTENDED; self.STX(); return 4; };

        //SUBA	
        this.optable[0x80] = function () { self.memmode = self.IMMEDIATE; self.SUBA(); return 2; };
        this.optable[0x90] = function () { self.memmode = self.DIRECT; self.SUBA(); return 2; };
        this.optable[0xa0] = function () { self.memmode = self.INDEX; self.SUBA(); return 2; };
        this.optable[0xb0] = function () { self.memmode = self.EXTENDED; self.SUBA(); return 2; };

        //SUBB	
        this.optable[0xc0] = function () { self.memmode = self.IMMEDIATE; self.SUBB(); return 2; };
        this.optable[0xd0] = function () { self.memmode = self.DIRECT; self.SUBB(); return 2; };
        this.optable[0xe0] = function () { self.memmode = self.INDEX; self.SUBB(); return 2; };
        this.optable[0xf0] = function () { self.memmode = self.EXTENDED; self.SUBB(); return 2; };

        //SUBD	
        this.optable[0x83] = function () { self.memmode = self.IMMEDIATE; self.SUBD(); return 4; };
        this.optable[0x93] = function () { self.memmode = self.DIRECT; self.SUBD(); return 4; };
        this.optable[0xa3] = function () { self.memmode = self.INDEX; self.SUBD(); return 4; };
        this.optable[0xb3] = function () { self.memmode = self.EXTENDED; self.SUBD(); return 4; };
        ...
        this.optable[0x00] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x02] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x03] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x12] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x13] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x14] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x15] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x18] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x1a] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x1c] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x1d] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x1e] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x1f] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x41] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x42] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x45] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x4b] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x4e] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x51] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x52] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x55] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x5b] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x5e] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x61] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x62] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x65] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x6b] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x71] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x72] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x75] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x7b] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x87] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0x8f] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0xc7] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0xcd] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
        this.optable[0xcf] = function () { self.memmode = self.IMMEDIATE; self.ERROR(); return 2; };
    },

    ERROR: function () {
        console.debug("ERROR: unknown opcode");
    },
    ABA: function () {
        ...
        if (address <= 0x1f) {
            switch (address) {
                ...
                case 0x08: //Timer Control and Status Register (TCSR)
                    this.clearTOF = this.memory[0x08] & 0x20;
                    this.clearOCF = this.memory[0x08] & 0x40;
                    return this.memory[address];

                case 0x09: //Counter (High byte)
                    if (this.clearTOF) {
                        this.memory[0x08] &= ~(0x20); // clear TOF flag on read
                        this.clearTOF = false;
                    }
                    return this.cycleCount >> 8;
    ...
    setMemory: function (address, value) {
        ...
        //is it video ram?
        if ((address >= 0x4000) && (address < 0x5200)) {
            ...
            switch (address) {
                ...
                case 0x08: //timer control register
                    if (value > 31) //only bits 0-4 are writable
                        break;
                    this.memory[0x08] = (this.memory[0x08] & 0xf0) + value;
                    return;
                ...
                case 0x0d: //input compare register (readonly)
                case 0x0e:
                    break;
...
MC10.MC6847.prototype = {
    ...
    RG2: function (pos, val) {
        var screenX, screenY;

        screenX = (pos % 16);
        screenY = ((pos - screenX) / 16);
        screenX *= 32;
        screenY *= 4;
        ...
        for (var x = 0; x < 4; x++) {
            for (var y = 0; y < 4; y++) {
                for (var i = 0; i < 32; i += 4) {
                    color = ((val >> (i / 4)) & 0x01) ? (this.palette) ? 4 : 0 : 9;
                    var idx0 = ((screenY * 512) + (y * 512) + screenX + (28 - i) + x) * 4;
        ...
        for (var x = 0; x < 4; x++) {
            for (var y = 0; y < 4; y++) {
                for (var i = 0; i < 16; i += 4) {
                    color = (val >> i / 2) & 0x03;
                    if (this.palette) color += 4;
                    var idx0 = ((screenY * 512) + (y * 512) + screenX + (12 - i) + x) * 4;
                    data[idx0] = MC10.MC6847.Palette[color][0];
                    data[idx0 + 1] = MC10.MC6847.Palette[color][1];
                    data[idx0 + 2] = MC10.MC6847.Palette[color][2];
                }
    ...
    updateSemiGraphics: function (pos, val) {
        ...
        if (val <= 0x7f) {
            ...
            for (var i = 0; i < 12; i++) {
                block[i] = MC10.MC6847.SG4CharacterSet[val][i];
            }
        } else {
            bgColorIndex = 8;
            switch (val & 0xf0) {
    ...
    updateAudio: function () {
        this.frequency = this.sampleCount * 59.88;
        //if (this.sampleCount > 0) {
        //    console.log("cnt: " + this.sampleCount);
    ...
    updateChip: function (val) {
        if (!this.toggleSpeaker && (val & 0x80)) {
            this.sampleCount++;
